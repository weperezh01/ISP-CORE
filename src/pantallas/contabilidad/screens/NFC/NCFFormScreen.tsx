...
const NCFFormScreen = () => {
    ...
    const handleSubmit = async () => {
        try {
            await api.post('/ncf', form);
            alert('NCF registrado con éxito');
        } catch (error) {
            console.error('Error al registrar NCF:', error);
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.header}>Registrar NCF</Text>
